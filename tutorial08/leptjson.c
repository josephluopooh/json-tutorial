...
void lept_copy(lept_value *dst, const lept_value *src)
{
    ...
    case LEPT_ARRAY:
        ...
        for (i = 0; i < src->u.a.size; i++)
        {
            ...
            lept_copy((lept_value *)&dst->u.a.e[i], (lept_value *)&src->u.a.e[i]);
        }
        break;
    case LEPT_OBJECT:
...
int lept_is_equal(const lept_value *lhs, const lept_value *rhs)
{
    ...
    case LEPT_OBJECT:
        ...
        for (i = 0; i < lhs->u.o.size; i++)
            if (!lept_is_equal(&lhs->u.o.m[i].v, lept_get_object_value((lept_value *)rhs, lept_find_object_index(rhs, lhs->u.o.m[i].k, lhs->u.o.m[i].klen))))
                return 0;
        return 1;
    default:
        return 1;
...
void lept_erase_array_element(lept_value *v, size_t index, size_t count)
{
    ...
    memmove(&v->u.a.e[index], &v->u.a.e[index + count], (v->u.a.size - count - index) * sizeof(lept_value));
    v->u.a.size -= count;
}
